            ...
            <ul className={styles.navList}>
              <li>
                <button
                  ...
                  className={`${styles.navBtn} ${active === 'general' ? styles.navBtnActive : styles.navBtnInactive}`}
                >
                  General
                </button>
              </li>
              ...
              <li>
                <button
                  ...
                  className={`${styles.navBtn} ${active === 'currency' ? styles.navBtnActive : styles.navBtnInactive}`}
                >
                  Currency
                </button>
              </li>
              ...
              <li>
                <button
                  ...
                  className={`${styles.navBtn} ${active === 'notifications' ? styles.navBtnActive : styles.navBtnInactive}`}
                >
                  Notifications
                </button>
              </li>
